...
class Gemma2Config(PretrainedConfig):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if "action_expert_config" in kwargs:
            self.action_expert_config = kwargs.pop("action_expert_config")
...
from model_policy import PI0PreTrainedConfig


@dataclass
class PI0Config(PI0PreTrainedConfig):
