...
from hub_utils import HubMixin
...
# Generic variable tha is either PreTrainedConfig or a subclass thereof
T = TypeVar("T", bound="PI0PreTrainedConfig")


@dataclass
class PI0PreTrainedConfig(draccus.ChoiceRegistry, HubMixin, abc.ABC):
    """
